...
const VIEW_LABELS_AR = {
  ...
  documents: 'الوثائق و KYC',
  supervisor: 'وحدة المشرف الميداني',
  workforce: 'الفرق والمناطق التشغيلية',
...
const VIEW_LABELS_EN = {
  ...
  rider360: 'Driver 360',
  vehicles: 'Vehicles & Maintenance',
  documents: 'Documents & KYC',
  supervisor: 'Field Supervisor Unit',
  workforce: 'Workforce & Zones',
...
const VIEW_GROUPS_AR = [
  ...
  { group: 'القوى العاملة', views: ['riders', 'workforce', 'documents', 'vehicles', 'imports'] },
  { group: 'العمليات', views: ['supervisor', 'shifts', 'dedicatedShifts', 'capacity'] },
...
const VIEW_GROUPS_EN = [
  ...
  { group: 'WORKFORCE', views: ['riders', 'workforce', 'documents', 'vehicles', 'imports'] },
  { group: 'OPERATIONS', views: ['supervisor', 'shifts', 'dedicatedShifts', 'capacity'] },
